...
##        return self.rect.w, self.rect.h
    ...
    def doLines(self, max_line_w):
        ...
        while inx >= 0:
            ...
            # events.HACK: Find a better way to do this to include tabs and system characters and whatnot.
            ...
            if (lw > max_line_w):
                ...
                # events.TODO: Check for extra-long words here that exceed the length of a line, to wrap mid-word
            ...
            # If we reached a hard line break
                ...
                newline = newline.replace("\n", " ") # events.HACK: We know we have a newline character, which doesn't print nicely, so make it into a space. Comment this out to see what I mean.
...
#                pass
                ...
                used = None
                try:
                    if (e.key == events.K_RETURN):
                        c = "\n"
                    elif (e.key == events.K_TAB):
                        c = "  "
                    else:
