...
from pgu.gui import events, pguglobals, container
...
class App(container.Container):
    ...
    def loop(self):
        ...
        for e in pygame.event.get():
            if not (e.type == events.QUIT and self.mywindow):
                self.event(e)
