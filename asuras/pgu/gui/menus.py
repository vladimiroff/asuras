"""
"""
from pgu.gui import events, table, basic, button
...
class _Menu(button.Button):
    def __init__(self,parent,widget=None,**params): #events.TODO widget= could conflict with module widget
        ...
        self.connect(events.CLICK,self._open,None)
    ...
    def _open(self,value):
        ...
        self.options.connect(events.BLUR,self._close,None)
        self.options.focus()
        self.repaint()
    ...
    def add(self,w,fnc=None,value=None):
        ...
        b.connect(events.CLICK,self._valuefunc,{'fnc':fnc,'value':value})
